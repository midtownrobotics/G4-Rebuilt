...
public class ModuleIOSim implements ModuleIO {
  ...
  // One Kraken X60 BLDC motor per drive and steer mechanism, using FOC control.
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.driveCurrentAmpsSupply = Math.abs(driveSim.getCurrentDrawAmps());
    ...
    inputs.turnCurrentAmpsSupply = Math.abs(turnSim.getCurrentDrawAmps());
